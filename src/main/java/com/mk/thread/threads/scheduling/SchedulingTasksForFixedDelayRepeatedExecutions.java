package com.mk.thread.threads.scheduling;
...
import com.mk.common.ScheduledTaskA;
import com.mk.common.TimeUtils;
...
public class SchedulingTasksForFixedDelayRepeatedExecutions {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(
				"[" + currentThreadName + "] Task-1 first-run scheduled for " + dateFormatter.format(scheduledTime)
		...
		System.out.println("[" + currentThreadName + "] Task-2 first run scheduled " + delayMillis / 1000
				+ " seconds after " + dateFormatter.format(currentTime)
				+ " and then repeatedly at an interval of every " + intervalMillis2 / 1000 + " seconds!");
